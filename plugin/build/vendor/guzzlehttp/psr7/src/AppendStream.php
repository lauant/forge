 ...
 */
class AppendStream implements \Lauant\MCD\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\Lauant\MCD\Psr\Http\Message\StreamInterface $stream)
    {
    ...
    {
        return \Lauant\MCD\GuzzleHttp\Psr7\Utils::copyToString($this);
    }
    /**
