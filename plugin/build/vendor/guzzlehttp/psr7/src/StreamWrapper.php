...
class StreamWrapper
{
     ...
     */
    public static function getResource(\Lauant\MCD\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\Lauant\MCD\Psr\Http\Message\StreamInterface $stream)
    {
