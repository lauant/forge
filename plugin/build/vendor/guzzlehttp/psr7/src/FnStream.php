 ...
 */
class FnStream implements \Lauant\MCD\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\Lauant\MCD\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
