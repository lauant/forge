...
class AutomationsApi
{
    ...
    protected function archiveRequest($workflow_id)
    {
        ...
        if ($workflow_id === null || \is_array($workflow_id) && \count($workflow_id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $workflow_id when calling ');
        }
        ...
        // path params
        if ($workflow_id !== null) {
            $resourcePath = \str_replace('{' . 'workflow_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($workflow_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function deleteWorkflowEmailRequest($workflow_id, $workflow_email_id)
    {
        ...
        if ($workflow_email_id === null || \is_array($workflow_email_id) && \count($workflow_email_id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $workflow_email_id when calling ');
        }
        ...
        if ($workflow_email_id !== null) {
            $resourcePath = \str_replace('{' . 'workflow_email_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($workflow_email_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function listRequest($count = '10', $offset = '0', $fields = null, $exclude_fields = null, $before_create_time = null, $since_create_time = null, $before_start_time = null, $since_start_time = null, $status = null)
    {
        ...
        if ($before_start_time !== null) {
            $queryParams['before_start_time'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($before_start_time);
        }
        // query params
        if ($since_start_time !== null) {
            $queryParams['since_start_time'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($since_start_time);
        }
        // query params
        if ($status !== null) {
