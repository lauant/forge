...
class TemplatesApi
{
    ...
    protected function deleteTemplateRequest($template_id)
    {
        ...
        if ($template_id === null || \is_array($template_id) && \count($template_id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $template_id when calling ');
        }
        ...
        // path params
        if ($template_id !== null) {
            $resourcePath = \str_replace('{' . 'template_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($template_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function listRequest($fields = null, $exclude_fields = null, $count = '10', $offset = '0', $created_by = null, $since_date_created = null, $before_date_created = null, $type = null, $category = null, $folder_id = null, $sort_field = null, $sort_dir = null)
    {
        ...
        // query params
        if ($category !== null) {
            $queryParams['category'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($category);
        }
        // query params
        if ($folder_id !== null) {
