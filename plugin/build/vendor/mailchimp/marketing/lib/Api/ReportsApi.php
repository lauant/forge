...
class ReportsApi
{
    ...
    protected function getCampaignClickDetailsForLinkRequest($campaign_id, $link_id, $fields = null, $exclude_fields = null)
    {
        ...
        if ($link_id === null || \is_array($link_id) && \count($link_id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $link_id when calling ');
        }
        ...
        // path params
        if ($link_id !== null) {
            $resourcePath = \str_replace('{' . 'link_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($link_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function getEmailActivityForCampaignRequest($campaign_id, $fields = null, $exclude_fields = null, $count = '10', $offset = '0', $since = null)
    {
        ...
        // query params
        if ($since !== null) {
            $queryParams['since'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($since);
        }
        // path params
        if ($campaign_id !== null) {
            $resourcePath = \str_replace('{' . 'campaign_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($campaign_id), $resourcePath);
