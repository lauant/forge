...
class AuthorizedAppsApi
{
    ...
    protected function getRequest($app_id, $fields = null, $exclude_fields = null)
    {
        ...
        if ($app_id === null || \is_array($app_id) && \count($app_id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $app_id when calling ');
        }
        ...
        // path params
        if ($app_id !== null) {
            $resourcePath = \str_replace('{' . 'app_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($app_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function linkRequest($client_details)
    {
        ...
        if ($client_details === null || \is_array($client_details) && \count($client_details) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $client_details when calling ');
        }
        $resourcePath = '/authorized-apps';
        $formParams = [];
        $queryParams = [];
