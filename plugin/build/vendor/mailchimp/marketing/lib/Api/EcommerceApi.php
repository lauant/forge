...
class EcommerceApi
{
    ...
    protected function deleteStoreRequest($store_id)
    {
        ...
        if ($store_id === null || \is_array($store_id) && \count($store_id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $store_id when calling ');
        }
        ...
        // path params
        if ($store_id !== null) {
            $resourcePath = \str_replace('{' . 'store_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($store_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function deleteStoreCartRequest($store_id, $cart_id)
    {
        ...
        if ($cart_id === null || \is_array($cart_id) && \count($cart_id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $cart_id when calling ');
        }
        ...
        // path params
        if ($cart_id !== null) {
            $resourcePath = \str_replace('{' . 'cart_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($cart_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function deleteCartLineItemRequest($store_id, $cart_id, $line_id)
    {
        ...
        if ($line_id === null || \is_array($line_id) && \count($line_id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $line_id when calling ');
        }
        ...
        // path params
        if ($line_id !== null) {
            $resourcePath = \str_replace('{' . 'line_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($line_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function deleteStoreCustomerRequest($store_id, $customer_id)
    {
        ...
        if ($customer_id === null || \is_array($customer_id) && \count($customer_id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $customer_id when calling ');
        }
        ...
        // path params
        if ($customer_id !== null) {
            $resourcePath = \str_replace('{' . 'customer_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($customer_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function deleteOrderRequest($store_id, $order_id)
    {
        ...
        if ($order_id === null || \is_array($order_id) && \count($order_id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $order_id when calling ');
        }
        ...
        // path params
        if ($order_id !== null) {
            $resourcePath = \str_replace('{' . 'order_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($order_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function deleteStoreProductRequest($store_id, $product_id)
    {
        ...
        if ($product_id === null || \is_array($product_id) && \count($product_id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $product_id when calling ');
        }
        ...
        // path params
        if ($product_id !== null) {
            $resourcePath = \str_replace('{' . 'product_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($product_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function deleteProductImageRequest($store_id, $product_id, $image_id)
    {
        ...
        if ($image_id === null || \is_array($image_id) && \count($image_id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $image_id when calling ');
        }
        ...
        // path params
        if ($image_id !== null) {
            $resourcePath = \str_replace('{' . 'image_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($image_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function deleteProductVariantRequest($store_id, $product_id, $variant_id)
    {
        ...
        if ($variant_id === null || \is_array($variant_id) && \count($variant_id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $variant_id when calling ');
        }
        ...
        // path params
        if ($variant_id !== null) {
            $resourcePath = \str_replace('{' . 'variant_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($variant_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function deletePromoCodeRequest($store_id, $promo_rule_id, $promo_code_id)
    {
        ...
        if ($promo_rule_id === null || \is_array($promo_rule_id) && \count($promo_rule_id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $promo_rule_id when calling ');
        }
        // verify the required parameter 'promo_code_id' is set
        if ($promo_code_id === null || \is_array($promo_code_id) && \count($promo_code_id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $promo_code_id when calling ');
        }
        ...
        if ($promo_rule_id !== null) {
            $resourcePath = \str_replace('{' . 'promo_rule_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($promo_rule_id), $resourcePath);
        }
        // path params
        if ($promo_code_id !== null) {
            $resourcePath = \str_replace('{' . 'promo_code_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($promo_code_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function ordersRequest($fields = null, $exclude_fields = null, $count = '10', $offset = '0', $campaign_id = null, $outreach_id = null, $customer_id = null, $has_outreach = null)
    {
        ...
        // query params
        if ($outreach_id !== null) {
            $queryParams['outreach_id'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($outreach_id);
        }
        // query params
        if ($customer_id !== null) {
            $queryParams['customer_id'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($customer_id);
        }
        // query params
        if ($has_outreach !== null) {
            $queryParams['has_outreach'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($has_outreach);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function getAllStoreCustomersRequest($store_id, $fields = null, $exclude_fields = null, $count = '10', $offset = '0', $email_address = null)
    {
        ...
        if ($email_address !== null) {
            $queryParams['email_address'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($email_address);
        }
        // path params
        if ($store_id !== null) {
            $resourcePath = \str_replace('{' . 'store_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($store_id), $resourcePath);
