...
class FileManagerApi
{
    ...
    protected function deleteFileRequest($file_id)
    {
        ...
        if ($file_id === null || \is_array($file_id) && \count($file_id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $file_id when calling ');
        }
        ...
        // path params
        if ($file_id !== null) {
            $resourcePath = \str_replace('{' . 'file_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($file_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function deleteFolderRequest($folder_id)
    {
        ...
        if ($folder_id === null || \is_array($folder_id) && \count($folder_id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $folder_id when calling ');
        }
        ...
        // path params
        if ($folder_id !== null) {
            $resourcePath = \str_replace('{' . 'folder_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($folder_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function filesRequest($fields = null, $exclude_fields = null, $count = '10', $offset = '0', $type = null, $created_by = null, $before_created_at = null, $since_created_at = null, $sort_field = null, $sort_dir = null)
    {
        ...
        // query params
        if ($created_by !== null) {
            $queryParams['created_by'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($created_by);
        }
        // query params
