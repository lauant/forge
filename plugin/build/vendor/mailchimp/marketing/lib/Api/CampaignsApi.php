...
class CampaignsApi
{
    ...
    protected function removeRequest($campaign_id)
    {
        ...
        if ($campaign_id === null || \is_array($campaign_id) && \count($campaign_id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $campaign_id when calling ');
        }
        ...
        // path params
        if ($campaign_id !== null) {
            $resourcePath = \str_replace('{' . 'campaign_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($campaign_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function deleteFeedbackMessageRequest($campaign_id, $feedback_id)
    {
        ...
        if ($feedback_id === null || \is_array($feedback_id) && \count($feedback_id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $feedback_id when calling ');
        }
        ...
        // path params
        if ($feedback_id !== null) {
            $resourcePath = \str_replace('{' . 'feedback_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($feedback_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function listRequest($fields = null, $exclude_fields = null, $count = '10', $offset = '0', $type = null, $status = null, $before_send_time = null, $since_send_time = null, $before_create_time = null, $since_create_time = null, $list_id = null, $folder_id = null, $member_id = null, $sort_field = null, $sort_dir = null)
    {
        ...
        if ($before_send_time !== null) {
            $queryParams['before_send_time'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($before_send_time);
        }
        // query params
        if ($since_send_time !== null) {
            $queryParams['since_send_time'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($since_send_time);
        }
        // query params
        if ($before_create_time !== null) {
            $queryParams['before_create_time'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($before_create_time);
        }
        // query params
        if ($since_create_time !== null) {
            $queryParams['since_create_time'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($since_create_time);
        }
        // query params
        if ($list_id !== null) {
        ...
        // query params
        if ($folder_id !== null) {
            $queryParams['folder_id'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($folder_id);
        }
        // query params
        if ($member_id !== null) {
            $queryParams['member_id'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($member_id);
        }
        // query params
        if ($sort_field !== null) {
