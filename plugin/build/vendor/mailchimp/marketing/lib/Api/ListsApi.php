...
use Lauant\MCD\GuzzleHttp\Exception\ClientException;
...
class ListsApi
{
    ...
    protected function deleteListRequest($list_id)
    {
        ...
        if ($list_id === null || \is_array($list_id) && \count($list_id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $list_id when calling ');
        }
        ...
        // path params
        if ($list_id !== null) {
            $resourcePath = \str_replace('{' . 'list_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($list_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function deleteInterestCategoryRequest($list_id, $interest_category_id)
    {
        ...
        if ($interest_category_id === null || \is_array($interest_category_id) && \count($interest_category_id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $interest_category_id when calling ');
        }
        ...
        if ($interest_category_id !== null) {
            $resourcePath = \str_replace('{' . 'interest_category_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($interest_category_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function deleteInterestCategoryInterestRequest($list_id, $interest_category_id, $interest_id)
    {
        ...
        if ($interest_id === null || \is_array($interest_id) && \count($interest_id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $interest_id when calling ');
        }
        ...
        // path params
        if ($interest_id !== null) {
            $resourcePath = \str_replace('{' . 'interest_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($interest_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function deleteListMemberRequest($list_id, $subscriber_hash)
    {
        ...
        if ($subscriber_hash === null || \is_array($subscriber_hash) && \count($subscriber_hash) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $subscriber_hash when calling ');
        }
        ...
        if ($subscriber_hash !== null) {
            $resourcePath = \str_replace('{' . 'subscriber_hash' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($subscriber_hash), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function deleteListMemberNoteRequest($list_id, $subscriber_hash, $note_id)
    {
        ...
        if ($note_id === null || \is_array($note_id) && \count($note_id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $note_id when calling ');
        }
        ...
        // path params
        if ($note_id !== null) {
            $resourcePath = \str_replace('{' . 'note_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($note_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function deleteListMergeFieldRequest($list_id, $merge_id)
    {
        ...
        if ($merge_id === null || \is_array($merge_id) && \count($merge_id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $merge_id when calling ');
        }
        ...
        // path params
        if ($merge_id !== null) {
            $resourcePath = \str_replace('{' . 'merge_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($merge_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function deleteSegmentRequest($list_id, $segment_id)
    {
        ...
        if ($segment_id === null || \is_array($segment_id) && \count($segment_id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $segment_id when calling ');
        }
        ...
        // path params
        if ($segment_id !== null) {
            $resourcePath = \str_replace('{' . 'segment_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($segment_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function deleteListWebhookRequest($list_id, $webhook_id)
    {
        ...
        if ($webhook_id === null || \is_array($webhook_id) && \count($webhook_id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $webhook_id when calling ');
        }
        ...
        // path params
        if ($webhook_id !== null) {
            $resourcePath = \str_replace('{' . 'webhook_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($webhook_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function getAllListsRequest($fields = null, $exclude_fields = null, $count = '10', $offset = '0', $before_date_created = null, $since_date_created = null, $before_campaign_last_sent = null, $since_campaign_last_sent = null, $email = null, $sort_field = null, $sort_dir = null, $has_ecommerce_store = null)
    {
        ...
        if ($before_date_created !== null) {
            $queryParams['before_date_created'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($before_date_created);
        }
        // query params
        if ($since_date_created !== null) {
            $queryParams['since_date_created'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($since_date_created);
        }
        // query params
        if ($before_campaign_last_sent !== null) {
            $queryParams['before_campaign_last_sent'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($before_campaign_last_sent);
        }
        // query params
        if ($since_campaign_last_sent !== null) {
            $queryParams['since_campaign_last_sent'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($since_campaign_last_sent);
        }
        // query params
        if ($email !== null) {
            $queryParams['email'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($email);
        }
        // query params
        if ($sort_field !== null) {
        ...
        if ($has_ecommerce_store !== null) {
            $queryParams['has_ecommerce_store'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($has_ecommerce_store);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function getListAbuseReportDetailsRequest($list_id, $report_id, $fields = null, $exclude_fields = null, $count = '10', $offset = '0')
    {
        ...
        if ($report_id === null || \is_array($report_id) && \count($report_id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $report_id when calling ');
        }
        if ($count !== null && $count > 1000) {
            throw new \InvalidArgumentException('invalid value for "$count" when calling ListsApi., must be smaller than or equal to 1000.');
        }
        ...
        // path params
        if ($report_id !== null) {
            $resourcePath = \str_replace('{' . 'report_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($report_id), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function getListGrowthHistoryByMonthRequest($list_id, $month, $fields = null, $exclude_fields = null)
    {
        ...
        if ($month === null || \is_array($month) && \count($month) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $month when calling ');
        }
        ...
        // path params
        if ($month !== null) {
            $resourcePath = \str_replace('{' . 'month' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($month), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function getListInterestCategoriesRequest($list_id, $fields = null, $exclude_fields = null, $count = '10', $offset = '0', $type = null)
    {
        ...
        // query params
        if ($type !== null) {
            $queryParams['type'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($type);
        }
        // path params
        if ($list_id !== null) {
            $resourcePath = \str_replace('{' . 'list_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($list_id), $resourcePath);
    ...
    protected function getListMembersInfoRequest($list_id, $fields = null, $exclude_fields = null, $count = '10', $offset = '0', $email_type = null, $status = null, $since_timestamp_opt = null, $before_timestamp_opt = null, $since_last_changed = null, $before_last_changed = null, $unique_email_id = null, $vip_only = null, $interest_category_id = null, $interest_ids = null, $interest_match = null, $sort_field = null, $sort_dir = null, $since_last_campaign = null, $unsubscribed_since = null)
    {
        ...
        // query params
        if ($email_type !== null) {
            $queryParams['email_type'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($email_type);
        }
        // query params
        if ($status !== null) {
            $queryParams['status'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($status);
        }
        // query params
        if ($since_timestamp_opt !== null) {
            $queryParams['since_timestamp_opt'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($since_timestamp_opt);
        }
        // query params
        if ($before_timestamp_opt !== null) {
            $queryParams['before_timestamp_opt'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($before_timestamp_opt);
        }
        // query params
        if ($since_last_changed !== null) {
            $queryParams['since_last_changed'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($since_last_changed);
        }
        // query params
        if ($before_last_changed !== null) {
            $queryParams['before_last_changed'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($before_last_changed);
        }
        // query params
        if ($unique_email_id !== null) {
            $queryParams['unique_email_id'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($unique_email_id);
        }
        // query params
        if ($vip_only !== null) {
            $queryParams['vip_only'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($vip_only);
        }
        // query params
        if ($interest_category_id !== null) {
            $queryParams['interest_category_id'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($interest_category_id);
        }
        // query params
        if ($interest_ids !== null) {
            $queryParams['interest_ids'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($interest_ids);
        }
        // query params
        if ($interest_match !== null) {
            $queryParams['interest_match'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($interest_match);
        }
        // query params
        if ($sort_field !== null) {
            $queryParams['sort_field'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($sort_field);
        ...
        if ($since_last_campaign !== null) {
            $queryParams['since_last_campaign'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($since_last_campaign);
        }
        // query params
        if ($unsubscribed_since !== null) {
            $queryParams['unsubscribed_since'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($unsubscribed_since);
        }
        // path params
        if ($list_id !== null) {
            $resourcePath = \str_replace('{' . 'list_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($list_id), $resourcePath);
    ...
    public function getListMemberWithHttpInfo($list_id, $subscriber_hash, $fields = null, $exclude_fields = null)
    {
        ...
        try {
            ...
            try {
                $response = $this->client->send($request, $options);
            } catch (\Lauant\MCD\GuzzleHttp\Exception\ClientException $e) {
                throw $e;
            }
            $statusCode = $response->getStatusCode();
            if ($statusCode < 200 || $statusCode > 299) {
    ...
    protected function getListMemberActivityRequest($list_id, $subscriber_hash, $fields = null, $exclude_fields = null, $action = null)
    {
        ...
        if (\is_array($action)) {
            ...
            if ($action !== null) {
                $queryParams['action'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($action);
            }
        }
        // path params
        if ($list_id !== null) {
    ...
    protected function getListMemberActivityFeedRequest($list_id, $subscriber_hash, $fields = null, $exclude_fields = null, $count = '10', $offset = '0', $activity_filters = null)
    {
        ...
        if (\is_array($activity_filters)) {
            ...
            if ($activity_filters !== null) {
                $queryParams['activity_filters'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($activity_filters);
            }
        }
        // path params
        if ($list_id !== null) {
    ...
    protected function getListMergeFieldsRequest($list_id, $fields = null, $exclude_fields = null, $count = '10', $offset = '0', $type = null, $required = null)
    {
        ...
        // query params
        if ($required !== null) {
            $queryParams['required'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($required);
        }
        // path params
        if ($list_id !== null) {
            $resourcePath = \str_replace('{' . 'list_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($list_id), $resourcePath);
    ...
    protected function getSegmentRequest($list_id, $segment_id, $fields = null, $exclude_fields = null, $include_cleaned = null, $include_transactional = null, $include_unsubscribed = null)
    {
        ...
        if ($include_cleaned !== null) {
            $queryParams['include_cleaned'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($include_cleaned);
        }
        // query params
        if ($include_transactional !== null) {
            $queryParams['include_transactional'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($include_transactional);
        }
        // query params
        if ($include_unsubscribed !== null) {
            $queryParams['include_unsubscribed'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($include_unsubscribed);
        }
        // path params
        if ($list_id !== null) {
            $resourcePath = \str_replace('{' . 'list_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($list_id), $resourcePath);
    ...
    protected function updateListMemberRequest($list_id, $subscriber_hash, $body, $skip_merge_validation = null)
    {
        ...
        if ($skip_merge_validation !== null) {
            $queryParams['skip_merge_validation'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($skip_merge_validation);
        }
        // path params
        if ($list_id !== null) {
            $resourcePath = \str_replace('{' . 'list_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($list_id), $resourcePath);
    ...
    protected function batchListMembersRequest($list_id, $body, $skip_merge_validation = null, $skip_duplicate_check = null)
    {
        ...
        if ($skip_duplicate_check !== null) {
            $queryParams['skip_duplicate_check'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($skip_duplicate_check);
        }
        // path params
        if ($list_id !== null) {
            $resourcePath = \str_replace('{' . 'list_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($list_id), $resourcePath);
    ...
    protected function listSegmentsRequest($list_id, $fields = null, $exclude_fields = null, $count = '10', $offset = '0', $type = null, $since_created_at = null, $before_created_at = null, $include_cleaned = null, $include_transactional = null, $include_unsubscribed = null, $since_updated_at = null, $before_updated_at = null)
    {
        ...
        if ($since_created_at !== null) {
            $queryParams['since_created_at'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($since_created_at);
        }
        // query params
        if ($before_created_at !== null) {
            $queryParams['before_created_at'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($before_created_at);
        }
        // query params
        if ($include_cleaned !== null) {
            $queryParams['include_cleaned'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($include_cleaned);
        ...
        if ($since_updated_at !== null) {
            $queryParams['since_updated_at'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($since_updated_at);
        }
        // query params
        if ($before_updated_at !== null) {
            $queryParams['before_updated_at'] = \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toQueryValue($before_updated_at);
        }
        // path params
        if ($list_id !== null) {
            $resourcePath = \str_replace('{' . 'list_id' . '}', \Lauant\MCD\MailchimpMarketing\ObjectSerializer::toPathValue($list_id), $resourcePath);
    ...
    protected function setListMemberRequest($list_id, $subscriber_hash, $body, $skip_merge_validation = null)
    {
        ...
        $headers = \array_merge($defaultHeaders, $headerParams, $headers);
        $query = \Lauant\MCD\GuzzleHttp\Psr7\build_query($queryParams);
        return new \Lauant\MCD\GuzzleHttp\Psr7\Request('PUT', $this->config->getHost() . $resourcePath . ($query ? "?{$query}" : ''), $headers, $httpBody);
    }
