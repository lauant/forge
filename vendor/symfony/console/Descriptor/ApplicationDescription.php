...
class ApplicationDescription
{
     ...
     */
    private $aliases;
    public function __construct(\Lauant\Forge\Symfony\Component\Console\Application $application, $namespace = null)
    {
    ...
    public function getCommand($name)
    {
        if (!isset($this->commands[$name]) && !isset($this->aliases[$name])) {
            throw new \Lauant\Forge\Symfony\Component\Console\Exception\CommandNotFoundException(\sprintf('Command %s does not exist.', $name));
        }
